...
def play_one_round(strategy_1, strategy_2):
    ...
    return (
        get_payoff(player_ones_move, player_twos_move),
        get_payoff(player_twos_move, player_ones_move)
    )
...
def play_game(strategy_1, strategy_2, rounds=200):
    ...
    for _ in range(rounds):
        scores = play_one_round(strategy_1, strategy_2)
